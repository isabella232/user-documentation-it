...
Here is the repository where you will find the Italian documentation on how to create, maintain, and make the most of a PrestaShop online store.
...
This repository is synchronized with GitBook, a tool that allows creating modern and intuitive documentation pages. You can find the PrestaShop Italian documentation [here](https://github.com/PrestaShop/user-documentation-it).
